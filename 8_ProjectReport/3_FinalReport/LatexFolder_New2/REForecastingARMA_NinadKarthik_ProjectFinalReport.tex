...
% The paper headers
\markboth{Optimal Estimation and Kalman Filtering Project Report, December~2018}%
...
\subsection{Dealing with Non-stationary Data}
...
The outputs for these tests and their related implications are listed in Table \ref{tab1}. If the conclusion is that the series is trend stationary, using seasonality should help make the series wide-sense stationary (WSS). In the case of the tests indicating the presence of a unit root, single lags can be used to turn it into a WSS series.

\begin{table}[htbp]
  \centering
  \caption{The KPSS and ADF test for Stationarity}
\begin{tabular}{|l|l|l|}
\hline
\textbf{Result \textbackslash Test} & \textbf{KPSS Test}   & \textbf{ADF Test}                                                                             \\ \hline
\textbf{Null Hypothesis}            & Trend Stationary     & Unit Root is present                                                                          \\ \hline
\textbf{Alternative Hypothesis}     & Unit Root is present & \begin{tabular}[c]{@{}l@{}}No Unit Root, can be stationary\\ or trend stationary\end{tabular} \\ \hline
\end{tabular}
\label{tab1}
\end{table}

Once the series has been deemed to be sufficiently WSS, we move on to determining the order of the ARMA model. This is done using the Autocorrelation Function (ACF) and Partial Autocorrelation Function (PACF). The outputs of these two functions are used to decide the model order using the various outcomes described in Table \ref{tab2}, with the ACF deciding the order of the MA component and the PACF deciding the order of the AR component.

\begin{table}[htbp]
  \centering
  \caption{Finding ARMA Model Order from ACF and PACF plots}
\begin{tabular}{|l|l|l|}
\hline
\textbf{Model} & \textbf{ACF}                                                        & \textbf{PACF}                                                       \\ \hline
\textbf{AR}    & Decaying                                                            & \begin{tabular}[c]{@{}l@{}}Significant\\   till p Lags\end{tabular} \\ \hline
\textbf{MA}    & \begin{tabular}[c]{@{}l@{}}Significant\\   till q Lags\end{tabular} & Decaying                                                            \\ \hline
\textbf{ARMA}  & Decaying                                                            & Decaying                                                            \\ \hline
\end{tabular}
\label{tab2}
\end{table}
...
In the first instance, we have applied the functions on the unaltered original data series. The results are as shown in Fig. \ref{fig9}. We observe that the ACF has an exponentially decaying plot while the PACF has a plot that decays much faster, with about 4 significant lag orders.
...
\begin{table}[htpb]
  \centering
  \caption{ARMA Models Specifications for evaluation}
\begin{tabular}{|l|l|l|l|l|l|}
\hline
\textbf{Model}  & \textbf{Single Lag} & \textbf{AR}                                                       & \textbf{MA}                                                   & \textbf{SAR} & \textbf{SMA} \\ \hline
\textbf{AR-1}   & 0                   & 1,2,3                                                             & 0                                                             & 0            & 0            \\ \hline
\textbf{AR-2}   & 0                   & 1,288                                                             &                                                               & 0            & 0            \\ \hline
\textbf{AR-3}   & 0                   & \begin{tabular}[c]{@{}l@{}}1,288,576,\\     864,1152\end{tabular} &                                                               & 0            & 0            \\ \hline
\textbf{MA-1}   & 1                   & 0                                                                 & 1,2,3                                                         & 0            & 0            \\ \hline
\textbf{MA-2}   & 1                   & 0                                                                 & 1                                                             & 0            & 288          \\ \hline
\textbf{MA-3}   & 1                   & 0                                                                 & \begin{tabular}[c]{@{}l@{}}1,576,\\     864,1152\end{tabular} & 0            & 288          \\ \hline
\textbf{ARMA-1} & 1                   & 1,2,3                                                             & 1,2,3                                                         & 0            & 0            \\ \hline
\textbf{ARMA-2} & 1                   & 1,288                                                             & 1,288                                                         & 288          & 288          \\ \hline
\textbf{ARMA-3} & 1                   & 1,288,576                                                         & 1,288,576                                                     & 288          & 288          \\ \hline
\end{tabular}
\label{tab3}
\end{table}
