...
elseif (r2==1) % Data With Date-Time
    ...
    [ OriginalSeries1,StartIndex,EndIndex ] = DateTimeSeriesSlicer(OriginalDataSeries,1,Res,StartYear,EndYear,StartMonth,EndMonth,StartDay,EndDay,StartTime,EndTime);
...
% PercentageError=abs(((OriginalSeries1-ForecastSeries)./(ForecastSeries))*100);
...
elseif (r2==1)
    ...
    HorizontalExcelIntraDay={'Day','Month','Year','Time','Forecasted Series','Original Series','Absolute Error Percentage'};
