...
D=1; % Number of Single Lag Differences 

Q=0; % MA Process Order

ARlags=0; % Auto-Regressive Lag Vector

MAlags=[1]; % Moving Average Lag Vector

Season=288; % Seasonality

SARlags=0; % Auto-Regressive Seasonal Lag Vector

SMAlags=[288]; % Moving Average Seasonal Lag Vector

Const=NaN; % Constant in ARMA


ModelOption = 9; % Choose the Model Option depending on the Kind of Model Structure
...
[ForecastSeries,yMSE] = forecast(EstModel,ForecastPoints,'Y0',OriginalSeries);
