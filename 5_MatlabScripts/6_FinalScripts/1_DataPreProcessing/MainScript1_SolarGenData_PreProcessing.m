...
plot(OneDay_1Hour(:,1),OneDay_5min(:,2),'LineWidth',1.5);
plot(OneDay_2Hour(:,1),OneDay_15min(:,2),'r*:','LineWidth',1.5);
plot(OneDay_3Hour(:,1),OneDay_15min(:,2),'go--','LineWidth',1.5);
...
plot(DayIndex,DailyData(:,2),'LineWidth',1.5);
...
plot(MonthIndex,MonthlyData(:,2),'LineWidth',1.5);
